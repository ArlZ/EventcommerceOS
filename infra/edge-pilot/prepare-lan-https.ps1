...
& curl.exe --fail --silent --show-error --cacert $rootCertificatePath $healthUrl | Out-Null
if ($LASTEXITCODE -ne 0) {
  throw "HTTPS was created, but the host TLS health check failed at $healthUrl."
}

...
describe('POS menu publication abuse classification', () => {
  ...
  it('classifies authenticated Event Edge install receipts under EDGE_SYNC', () => {
    const classified = classifyAbuseRequest({
      method: 'POST',
      path: '/sync/events/11111111-1111-4111-8111-111111111111/pos-menu-install-receipts',
      headers: edgeHeaders,
    });

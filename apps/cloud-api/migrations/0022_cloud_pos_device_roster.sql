CREATE TABLE IF NOT EXISTS cloud_pos_device_roster (
...
CREATE INDEX IF NOT EXISTS cloud_pos_device_roster_event_idx
  ON cloud_pos_device_roster(event_id, status, device_id);

CREATE INDEX IF NOT EXISTS cloud_pos_device_roster_org_idx
  ON cloud_pos_device_roster(organisation_id, status, device_id);

...
4. Run offline POS/Event Edge durability followed by independent Cloud convergence and duplicate replay verification.
5. Run the authorised abuse/flood exercise.
6. Run the representative backup/restore drill and recovery review.
7. Reconcile inventory and perform the actual Event Close workflow.
...
10. Run `pnpm pilot:release:review` for the final machine-verifiable handoff to named human go/no-go.
